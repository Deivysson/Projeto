...
export function Login(){
    ...
    .then(response => {
        if (response.data.user) {
            const cod_paciente = response.data.user.cod_paciente;
            navigate(`/area?nom_paciente=${response.data.exames.nom_paciente}&num_cpf=${response.data.exames.num_cpf}&des_endereco=${response.data.exames.des_endereco}&des_email=${response.data.exames.des_email}&cod_paciente=${cod_paciente}`);
        } else {
